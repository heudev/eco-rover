            ...
            <div className="w-full lg:w-1/2 text-left p-6 flex flex-col justify-center items-center">
              ...
              <div className="flex flex-col lg:flex-row items-start justify-start gap-8 px-6 lg:px-12"> 
                ...
                <div className="flex items-center space-x-2 mb-2">
                  <h2 className="text-lg text-white">Co-Lead</h2>
                  <h2 className="text-lg text-orange-500 font-semibold">Burakcan Akçit</h2>
                </div>
                  <ul className="text-gray-300">
                    <li className="flex items-center mb-2">
                      <a href="mailto:burakcanakcit@gmail.com " className="hover:text-white transition-colors flex items-center"><svg className="h-6 w-6 text-orange-500 mr-2"  fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>burakcanakcit@gmail.com </a></li>
                    <li className="flex items-center mb-2">
                      <a href="https://www.linkedin.com/in/burakcan-akcit-2727a0223" className="hover:text-white transition-colors flex items-center"><svg className="h-6 w-6 text-orange-500 mr-2"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round"> <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" />  <rect x="2" y="9" width="4" height="12" /> <circle cx="4" cy="4" r="2" /></svg>linkedin.com/burakcan-akcit</a>
                    </li>
                    <li className="flex items-center mb-2">
                      <a href="https://www.instagram.com/burakcan.akcit" className="hover:text-white transition-colors flex items-center"><svg className="h-6 w-6 text-gradient-to-r  text-orange-500 mr-2"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round">  <rect x="2" y="2" width="20" height="20" rx="5" ry="5" />  <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" /> <line x1="17.5" y1="6.5" x2="17.51" y2="6.5" /></svg>instagram.com/burakcan.akcit</a>
                    </li>
                    <li className="flex items-center mb-2"><svg className="h-6 w-6 text-orange-500 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" /></svg>+90 538 010 88 81</li>
                 </ul>
                </div>
                ...
                <div className="flex flex-col w-full lg:w-1/2 items-start"> 
                  <div className="flex items-center space-x-2 mb-2">
                    <h2 className="text-lg text-white font-mono">Head of Finance</h2>
                    <h2 className="text-lg text-orange-500 font-thin">Irmak İşal</h2>
                  </div>
                  <ul className="text-gray-300">
                    <li className="flex items-center mb-2">
                      <a href="mailto:isalirmak@gmail.com " className="hover:text-white transition-colors flex items-center"><svg className="h-6 w-6 text-orange-500 mr-2"  fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>isalirmak@gmail.com </a></li>
                    <li className="flex items-center mb-2">
                      <a href="https://www.linkedin.com/in/irmak-i%C5%9Fal-8a64a4162" className="hover:text-white transition-colors flex items-center"><svg className="h-6 w-6 text-orange-500 mr-2"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round"> <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" />  <rect x="2" y="9" width="4" height="12" /> <circle cx="4" cy="4" r="2" /></svg>linkedin.com/in/irmak-işal</a>
                    </li>
                    <li className="flex items-center mb-2">
                      <a href="https://www.instagram.com/river_4991/?next=%2Fkultursebiha%2Ffeed%2F&hl=zh-cn" className="hover:text-white transition-colors flex items-center"><svg className="h-6 w-6 text-gradient-to-r  text-orange-500 mr-2"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round">  <rect x="2" y="2" width="20" height="20" rx="5" ry="5" />  <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" /> <line x1="17.5" y1="6.5" x2="17.51" y2="6.5" /></svg>instagram.com/river_4991</a>
                    </li>
                    <li className="flex items-center mb-2"><svg className="h-6 w-6 text-orange-500 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" /></svg>+90 506 155 90 95</li>
                  </ul>
                </div>
              </div>
